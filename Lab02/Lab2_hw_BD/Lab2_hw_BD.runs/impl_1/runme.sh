...
HD_PWD='C:/Users/Doris/Desktop/FPGA/Lab2_hw_BD/Lab2_hw_BD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HW2_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HW2_1_wrapper.tcl -notrace
