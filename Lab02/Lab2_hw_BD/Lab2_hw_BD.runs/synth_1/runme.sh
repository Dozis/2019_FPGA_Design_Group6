...
HD_PWD='C:/Users/Doris/Desktop/FPGA/Lab2_hw_BD/Lab2_hw_BD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW2_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW2_1_wrapper.tcl
