...
HD_PWD='Z:/FPGA_Group_6/HW4_v1/HW4_v1.runs/design_1_calculation_v1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_calculation_v1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_calculation_v1_0_0.tcl
